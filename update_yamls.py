...
add_state_node(
    "/workspaces/ha_data/config/custom_components/climate_ip/samsung_2878.yaml",
    map_2878,
)
add_state_node(
    "/workspaces/ha_data/config/custom_components/climate_ip/samsungrac.yaml", map_rac
)
print("Updated YAMLs")
