...
from custom_components.climate_ip.const import (
    CONF_DEVICE_TYPE, DEVICE_TYPE_SMARTTHINGS_HVAC, DEVICE_TYPE_SAMSUNG_2878
)
from custom_components.climate_ip.config_flow import ClimateIpConfigFlow, CONF_DEVICE_ID, CONF_NAME, CONF_POLL_INTERVAL
...
async def test_rest_api_schema_mutants_annihilation():
    ...
    assert dev_id_type is str  # Si el mutante asigna None a la derecha del dict, esto falla
    ...
    assert ip_key.default() == "192.168.1.99" # Mata al mutante 37 que usaría la IP de smartthings.com
